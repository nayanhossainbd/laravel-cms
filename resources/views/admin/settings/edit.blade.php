    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description"  rows="3">{{ old('description', $setting->description) }}</textarea>
            ...
            <div class="form-group">
                <label for="type">{{ trans('cruds.setting.fields.type') }}</label>
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $setting->type) }}">
                @if($errors->has('type'))
            ...
            <div class="form-group">
                <label for="phone_no">{{ trans('cruds.setting.fields.phone_no') }}</label>
                <input class="form-control {{ $errors->has('phone_no') ? 'is-invalid' : '' }}" type="text" name="phone_no" id="phone_no" value="{{ old('phone_no', $setting->phone_no) }}">
                @if($errors->has('phone_no'))
                    <span class="text-danger">{{ $errors->first('phone_no') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.phone_no_helper') }}</span>
            </div>
            <div class="form-group">
