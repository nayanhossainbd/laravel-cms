...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name">{{ trans('cruds.contactContact.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $contactContact->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('designation') ? 'is-invalid' : '' }}" type="text" name="designation" id="designation" value="{{ old('designation', $contactContact->designation) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_office_personal') ? 'is-invalid' : '' }}" type="text" name="email_office_personal" id="email_office_personal" value="{{ old('email_office_personal', $contactContact->email_office_personal) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_personal') ? 'is-invalid' : '' }}" type="text" name="email_personal" id="email_personal" value="{{ old('email_personal', $contactContact->email_personal) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $contactContact->telephone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('persona_age') ? 'is-invalid' : '' }}" type="text" name="persona_age" id="persona_age" value="{{ old('persona_age', $contactContact->persona_age) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" type="text" name="note" id="note" value="{{ old('note', $contactContact->note) }}">
                @if($errors->has('note'))
