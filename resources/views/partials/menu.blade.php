<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    {{-- <a href="/" class="brand-link">
      <img src="{{asset('website/images/logo.png')}}" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                     @if(Auth::user()->avator)
                        <a href="{{ Auth::user()->avator->getUrl() }}" target="_blank" style="display: inline-block">
                            <img src="{{ Auth::user()->avator->getUrl('thumb') }}">
                        </a>
                     @else 
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('content_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/content-categories*") ? "menu-open" : "" }} {{ request()->is("admin/content-tags*") ? "menu-open" : "" }} {{ request()->is("admin/content-posts*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('content_posts_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.content-posts.index") }}" class="nav-link {{ request()->is("admin/content-posts") || request()->is("admin/content-posts/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-file">

                                        </i>
                                        <p>
                                            {{ trans('cruds.contentPost.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
