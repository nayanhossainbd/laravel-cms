...
<script src="https://cdn.jsdelivr.net/combine/npm/@ckeditor/ckeditor5-code-block@23.1.0/src/codeblock.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/codeblockcommand.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/codeblockediting.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/codeblockui.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/converters.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/indentcodeblockcommand.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/outdentcodeblockcommand.min.js,npm/@ckeditor/ckeditor5-code-block@23.1.0/src/utils.min.js">
    ...
    <link href="{{ asset('css/assets/select2.min.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('css/assets/sans_pro.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/assets/dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/assets/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/assets/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/assets/select.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/assets/buttons.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/assets/dropzone.min.css') }}" rel="stylesheet" />
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script src="{{ asset('js/assets/dataTables.select.min.js') }}"></script>
    <script src="{{ asset('js/assets/buttons.flash.min.js') }}"></script>
  ...
  let languages = {
    ...
    'bn': 'https://cdn.datatables.net/plug-ins/1.10.21/i18n/Bangla.json'
