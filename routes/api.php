...
Route::group(['prefix' => 'v1', 'as' => 'api.', 'namespace' => 'Api\V1\Admin', 'middleware' => ['auth:api']], function () {
    ...
    // Content Pages
    Route::post('content-posts/media', 'ContentPageApiController@storeMedia')->name('content-posts.storeMedia');
    Route::apiResource('content-posts', 'ContentPageApiController');
