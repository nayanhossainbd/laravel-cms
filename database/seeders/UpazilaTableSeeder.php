...
["id"=>"24","district_id"=>"3","name"=>"Brahmanbaria Sadar","bn_name"=>"ব্রাহ্মণবাড়িয়া
সদর","url"=>"sadar.brahmanbaria.gov.bd"],
...
["id"=>"110","district_id"=>"12","name"=>"Sirajganj Sadar","bn_name"=>"সিরাজগঞ্জ
সদর","url"=>"sirajganjsadar.sirajganj.gov.bd"],
...
["id"=>"154","district_id"=>"17","name"=>"Joypurhat Sadar","bn_name"=>"জয়পুরহাট
সদর","url"=>"joypurhatsadar.joypurhat.gov.bd"],
["id"=>"155","district_id"=>"18","name"=>"Chapainawabganj Sadar","bn_name"=>"চাঁপাইনবাবগঞ্জ
সদর","url"=>"chapainawabganjsadar.chapainawabganj.gov.bd"],
...
["id"=>"192","district_id"=>"24","name"=>"Chuadanga Sadar","bn_name"=>"চুয়াডাঙ্গা
সদর","url"=>"chuadangasadar.chuadanga.gov.bd"],
...
["id"=>"288","district_id"=>"37","name"=>"Moulvibazar Sadar","bn_name"=>"মৌলভীবাজার
সদর","url"=>"moulvibazarsadar.moulvibazar.gov.bd"],
...
["id"=>"301","district_id"=>"39","name"=>"South Sunamganj","bn_name"=>"দক্ষিণ
সুনামগঞ্জ","url"=>"southsunamganj.sunamganj.gov.bd"],
...
["id"=>"313","district_id"=>"40","name"=>"Narsingdi Sadar","bn_name"=>"নরসিংদী
সদর","url"=>"narsingdisadar.narsingdi.gov.bd"],
...
["id"=>"330","district_id"=>"43","name"=>"Narayanganj Sadar","bn_name"=>"নারায়নগঞ্জ
সদর","url"=>"narayanganjsadar.narayanganj.gov.bd"],
...
["id"=>"352","district_id"=>"45","name"=>"Kishoreganj Sadar","bn_name"=>"কিশোরগঞ্জ
সদর","url"=>"kishoreganjsadar.kishoreganj.gov.bd"],
...
["id"=>"399","district_id"=>"53","name"=>"Panchagarh Sadar","bn_name"=>"পঞ্চগড়
সদর","url"=>"panchagarhsadar.panchagarh.gov.bd"],
...
["id"=>"427","district_id"=>"56","name"=>"Nilphamari Sadar","bn_name"=>"নীলফামারী
সদর","url"=>"nilphamarisadar.nilphamari.gov.bd"],
["id"=>"428","district_id"=>"57","name"=>"Sadullapur","bn_name"=>"সাদুল্লাপুর","url"=>"sadullapur.gaibandha.gov.bd"],
["id"=>"429","district_id"=>"57","name"=>"Gaibandha Sadar","bn_name"=>"গাইবান্ধা
সদর","url"=>"gaibandhasadar.gaibandha.gov.bd"],
...
["id"=>"435","district_id"=>"58","name"=>"Thakurgaon Sadar","bn_name"=>"ঠাকুরগাঁও
সদর","url"=>"thakurgaonsadar.thakurgaon.gov.bd"],
...
["id"=>"448","district_id"=>"60","name"=>"Kurigram Sadar","bn_name"=>"কুড়িগ্রাম
সদর","url"=>"kurigramsadar.kurigram.gov.bd"],
...
["id"=>"466","district_id"=>"62","name"=>"Mymensingh Sadar","bn_name"=>"ময়মনসিংহ
সদর","url"=>"mymensinghsadar.mymensingh.gov.bd"],
...
["id"=>"491","district_id"=>"64","name"=>"Netrokona Sadar","bn_name"=>"নেত্রকোণা
সদর","url"=>"netrokonasadar.netrokona.gov.bd"],
["id"=>"492","district_id"=>"47","name"=>"Adabor","bn_name"=>"আদাবর","url"=>"blank"],
["id"=>"493","district_id"=>"47","name"=>"Badda","bn_name"=>"বাড্ডা","url"=>"blank"],
["id"=>"494","district_id"=>"47","name"=>"Bangshal","bn_name"=>"বংশাল","url"=>"blank"],
["id"=>"495","district_id"=>"47","name"=>"Bimanbandar","bn_name"=>"বিমানবন্দর","url"=>"blank"],
["id"=>"496","district_id"=>"47","name"=>"Cantonment","bn_name"=>"ক্যান্টনমেন্ট","url"=>"blank"],
["id"=>"497","district_id"=>"47","name"=>" Chawkbazar Model ","bn_name"=>"চকবাজার মডেল","url"=>"blank"],
["id"=>"498","district_id"=>"47","name"=>"Dakshinkhan ","bn_name"=>"দক্ষিনখান","url"=>"blank"],
["id"=>"499","district_id"=>"47","name"=>"Darus Salam ","bn_name"=>"দারুস সালাম","url"=>"blank"],
["id"=>"500","district_id"=>"47","name"=>"Demra","bn_name"=>"ডেমরা","url"=>"blank"],
["id"=>"501","district_id"=>"47","name"=>"Dhanmondi","bn_name"=>"ধানমন্ডি","url"=>"blank"],
["id"=>"502","district_id"=>"47","name"=>"Gendaria","bn_name"=>"গেন্ডাড়িয়া","url"=>"blank"],
["id"=>"503","district_id"=>"47","name"=>"Gulshan","bn_name"=>"গুলশান","url"=>"blank"],
["id"=>"504","district_id"=>"47","name"=>"Hazaribagh","bn_name"=>"হাজারিবাগ","url"=>"blank"],
["id"=>"505","district_id"=>"47","name"=>"Jatrabari","bn_name"=>"যাত্রাবাড়ী","url"=>"blank"],
["id"=>"506","district_id"=>"47","name"=>"Kadamtali","bn_name"=>"কদমতলী","url"=>"blank"],
["id"=>"507","district_id"=>"47","name"=>"Kafrul","bn_name"=>"কাফ্রুল","url"=>"blank"],
["id"=>"508","district_id"=>"47","name"=>"Kalabagan","bn_name"=>"কলাবাগান","url"=>"blank"],
["id"=>"509","district_id"=>"47","name"=>"Kamrangirchar","bn_name"=>"কামড়াঙ্গীর চর","url"=>"blank"],
["id"=>"510","district_id"=>"47","name"=>"Khilkhet","bn_name"=>"খিলখেত","url"=>"blank"],
["id"=>"511","district_id"=>"47","name"=>"Khilgaon","bn_name"=>"খিলগাও","url"=>"blank"],
["id"=>"512","district_id"=>"47","name"=>"Kotwali","bn_name"=>"কতয়ালী","url"=>"blank"],
["id"=>"513","district_id"=>"47","name"=>"Lalbagh","bn_name"=>"লালবাগ","url"=>"blank"],
["id"=>"514","district_id"=>"47","name"=>" Mirpur Model ","bn_name"=>"মিরপুর মডেল","url"=>"blank"],
["id"=>"515","district_id"=>"47","name"=>"Mohammadpur","bn_name"=>"মোহাম্মাদপুর","url"=>"blank"],
["id"=>"516","district_id"=>"47","name"=>"Motijheel","bn_name"=>"মতিঝিল","url"=>"blank"],
["id"=>"517","district_id"=>"47","name"=>" New Market ","bn_name"=>"নিউ মার্কেট","url"=>"blank"],
["id"=>"518","district_id"=>"47","name"=>"Pallabi","bn_name"=>"পল্লবী","url"=>"blank"],
["id"=>"519","district_id"=>"47","name"=>"Paltan","bn_name"=>"পল্টন","url"=>"blank"],
["id"=>"520","district_id"=>"47","name"=>"Ramna","bn_name"=>"রমনা ","url"=>"blank"],
["id"=>"521","district_id"=>"47","name"=>"Rampura","bn_name"=>"রামপুরা ","url"=>"blank"],
["id"=>"522","district_id"=>"47","name"=>"Sabujbagh","bn_name"=>"সবুজবাগ","url"=>"blank"],
["id"=>"523","district_id"=>"47","name"=>"Shahbagh","bn_name"=>"শাহবাগ","url"=>"blank"],
["id"=>"524","district_id"=>"47","name"=>" Shah Ali ","bn_name"=>"শাহ আলী","url"=>"blank"],
["id"=>"525","district_id"=>"47","name"=>" Sher-e-Bangla Nagar","bn_name"=>"শের এ বাংলা নগর","url"=>"blank"],
["id"=>"526","district_id"=>"47","name"=>"Shyampur","bn_name"=>"শ্যামপুর","url"=>"blank"],
["id"=>"527","district_id"=>"47","name"=>"Sutrapur","bn_name"=>"সুত্রাপুর","url"=>"blank"]
];
